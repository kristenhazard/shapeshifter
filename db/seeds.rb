...
d_q6 = Hanuman::Question.create(question_text: 'Owner or Responsible Party Information', answer_type_id: answer_static.id)
...
d_q16 = Hanuman::Question.create(question_text: '', answer_type_id: answer_line.id)
#animal information
d_q17 = Hanuman::Question.create(question_text: 'Animal Information', answer_type_id: answer_static.id)
d_q18 = Hanuman::Question.create(question_text: 'Animal Name', answer_type_id: answer_text.id)
d_q19 = Hanuman::Question.create(question_text: 'Identification Code', answer_type_id: answer_text.id)
d_q20 = Hanuman::Question.create(question_text: 'Species', answer_type_id: answer_text.id)
d_q21 = Hanuman::Question.create(question_text: 'Breed', answer_type_id: answer_text.id)
d_q22 = Hanuman::Question.create(question_text: 'Color', answer_type_id: answer_text.id)
d_q23 = Hanuman::Question.create(question_text: 'Age', answer_type_id: answer_text.id)
d_q24 = Hanuman::Question.create(question_text: 'Sex', answer_type_id: answer_select.id)
d_q25 = Hanuman::Question.create(question_text: 'Reproductive Status', answer_type_id: answer_select.id)
d_q26 = Hanuman::Question.create(question_text: 'Ownership Status', answer_type_id: answer_select.id)
d_q27 = Hanuman::Question.create(question_text: 'Address', answer_type_id: answer_text.id)
d_q28 = Hanuman::Question.create(question_text: 'City', answer_type_id: answer_text.id)
d_q29 = Hanuman::Question.create(question_text: 'Zip Code', answer_type_id: answer_text.id)
d_q30 = Hanuman::Question.create(question_text: '', answer_type_id: answer_line.id)
#symptoms and date of recovery
d_q31 = Hanuman::Question.create(question_text: 'Symtoms & Date of Recovery', answer_type_id: answer_static.id)
d_q32 = Hanuman::Question.create(question_text: 'Symptoms', answer_type_id: answer_chosenmultiselect.id)
d_q33 = Hanuman::Question.create(question_text: 'Date of Recovery', answer_type_id: answer_date.id)
d_q34 = Hanuman::Question.create(question_text: '', answer_type_id: answer_line.id)
#other important dates
d_q35 = Hanuman::Question.create(question_text: 'Other Important Dates', answer_type_id: answer_static.id)
d_q36 = Hanuman::Question.create(question_text: 'Diagnosis Date', answer_type_id: answer_date.id)
d_q37 = Hanuman::Question.create(question_text: 'Date of Exposure', answer_type_id: answer_date.id)
d_q38 = Hanuman::Question.create(question_text: 'Date of Onset', answer_type_id: answer_date.id)
d_q39 = Hanuman::Question.create(question_text: 'Treatment Date', answer_type_id: answer_date.id)
d_q40 = Hanuman::Question.create(question_text: 'Date of Hospitalization', answer_type_id: answer_date.id)
d_q41 = Hanuman::Question.create(question_text: 'Date of Death', answer_type_id: answer_date.id)
d_q42 = Hanuman::Question.create(question_text: '', answer_type_id: answer_line.id)
#reporting agency or facility information
d_q43 = Hanuman::Question.create(question_text: 'Reporting Agency or Facility Information', answer_type_id: answer_static.id)
d_q44 = Hanuman::Question.create(question_text: 'Reporting Individual Name', answer_type_id: answer_text.id)
d_q45 = Hanuman::Question.create(question_text: 'Phone (805-765-4321)', answer_type_id: answer_text.id)
d_q46 = Hanuman::Question.create(question_text: 'Fax (805-765-4321)', answer_type_id: answer_text.id)
d_q47 = Hanuman::Question.create(question_text: 'Reporting Individual Occupation', answer_type_id: answer_text.id)
d_q48 = Hanuman::Question.create(question_text: 'Reporting Agency or Facility Name', answer_type_id: answer_text.id)
d_q49 = Hanuman::Question.create(question_text: 'Email', answer_type_id: answer_text.id)
d_q50 = Hanuman::Question.create(question_text: 'Address', answer_type_id: answer_text.id)
d_q51 = Hanuman::Question.create(question_text: 'City', answer_type_id: answer_text.id)
d_q52 = Hanuman::Question.create(question_text: 'Zip Code', answer_type_id: answer_text.id)
d_q53 = Hanuman::Question.create(question_text: '', answer_type_id: answer_line.id)
#lab information
d_q54 = Hanuman::Question.create(question_text: 'Lab Information', answer_type_id: answer_static.id)
d_q55 = Hanuman::Question.create(question_text: 'Lab Name', answer_type_id: answer_text.id)
d_q56 = Hanuman::Question.create(question_text: 'Phone (805-765-4321)', answer_type_id: answer_text.id)
d_q57 = Hanuman::Question.create(question_text: 'Fax (805-765-4321)', answer_type_id: answer_text.id)
d_q58 = Hanuman::Question.create(question_text: 'Address', answer_type_id: answer_text.id)
d_q59 = Hanuman::Question.create(question_text: 'City', answer_type_id: answer_text.id)
d_q60 = Hanuman::Question.create(question_text: 'Zip Code', answer_type_id: answer_text.id)
d_q61 = Hanuman::Question.create(question_text: 'Lab Collection Date', answer_type_id: answer_date.id)
d_q62 = Hanuman::Question.create(question_text: 'Speciman Type', answer_type_id: answer_text.id)
d_q63 = Hanuman::Question.create(question_text: 'Lab Test Type', answer_type_id: answer_text.id)
#report level single entry
d_q64 = Hanuman::Question.create(question_text: 'Enter Additional Important Information', answer_type_id: answer_textarea.id)
...
#sex
Hanuman::AnswerChoice.create(question_id: d_q21.id, option_text: 'Male')
Hanuman::AnswerChoice.create(question_id: d_q21.id, option_text: 'Female')
Hanuman::AnswerChoice.create(question_id: d_q21.id, option_text: 'Unknown')
#reproduction status
Hanuman::AnswerChoice.create(question_id: d_q22.id, option_text: 'Intact')
Hanuman::AnswerChoice.create(question_id: d_q22.id, option_text: 'Neutered/Spayed')
Hanuman::AnswerChoice.create(question_id: d_q22.id, option_text: 'Unknown')
#ownership status
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Pet')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Stray')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Feral')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Livestock')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Wild, Unowned')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Wild, Captive')
Hanuman::AnswerChoice.create(question_id: d_q23.id, option_text: 'Unknown')
#symptoms
d_answergroup_gi = Hanuman::AnswerChoice.create(question_id: d_q27.id, option_text: 'GI', scientific_text: 'GI')
d_answergroup_gi.children.create(question_id: d_q27.id, option_text: 'Abdominal Pain', scientific_text: 'Abdominal Pain')
d_answergroup_gi.children.create(question_id: d_q27.id, option_text: 'Diarrhea', scientific_text: 'Diarrhea')
d_answergroup_gi.children.create(question_id: d_q27.id, option_text: 'Nausea', scientific_text: 'Nausea')
d_answergroup_gi.children.create(question_id: d_q27.id, option_text: 'Vomiting', scientific_text: 'Vomiting')
d_answergroup_neurologic = Hanuman::AnswerChoice.create(question_id: d_q27.id, option_text: 'Neurologic', scientific_text: 'Neurologic')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Ascending', scientific_text: 'Ascending')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Blurred Vision', scientific_text: 'Blurred Vision')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Decending', scientific_text: 'Decending')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Delirium', scientific_text: 'Delirium')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Dysphagia', scientific_text: 'Dysphagia')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Headache', scientific_text: 'Headache')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Pain', scientific_text: 'Pain')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Paralysis', scientific_text: 'Paralysis')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Photophobia', scientific_text: 'Photophobia')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Seizures', scientific_text: 'Seizures')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Slurred Speech', scientific_text: 'Slurred Speech')
d_answergroup_neurologic.children.create(question_id: d_q27.id, option_text: 'Weakness', scientific_text: 'Weakness')
d_answergroup_non_specific = Hanuman::AnswerChoice.create(question_id: d_q27.id, option_text: 'Non Specific', scientific_text: 'Non Specific')
d_answergroup_non_specific.children.create(question_id: d_q27.id, option_text: 'Diaphoresis', scientific_text: 'Diaphoresis')
d_answergroup_non_specific.children.create(question_id: d_q27.id, option_text: 'Fever', scientific_text: 'Fever')
d_answergroup_non_specific.children.create(question_id: d_q27.id, option_text: 'Malaise', scientific_text: 'Malaise')
d_answergroup_non_specific.children.create(question_id: d_q27.id, option_text: 'Nodes', scientific_text: 'Nodes')
d_answergroup_non_specific.children.create(question_id: d_q27.id, option_text: 'Rigors', scientific_text: 'Rigors')
d_answergroup_respiratory = Hanuman::AnswerChoice.create(question_id: d_q27.id, option_text: 'Respiratory', scientific_text: 'Respiratory')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Chest Pain', scientific_text: 'Chest Pain')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Cough', scientific_text: 'Cough')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Cyanosis', scientific_text: 'Cyanosis')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Dyspnea', scientific_text: 'Dyspnea')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Haemoptysis', scientific_text: 'Coughing Up Blood')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'Productive', scientific_text: 'Productive')
d_answergroup_respiratory.children.create(question_id: d_q27.id, option_text: 'X-Ray', scientific_text: 'X-Ray')
d_answergroup_skin = Hanuman::AnswerChoice.create(question_id: d_q27.id, option_text: 'Skin', scientific_text: 'Skin')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Bleedig Gums', scientific_text: 'Bleedig Gums')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Blisters', scientific_text: 'Blisters')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Bruising', scientific_text: 'Bruising')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Eschar', scientific_text: 'Eschar')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Masculopapular', scientific_text: 'Masculopapular')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Peeling', scientific_text: 'Peeling')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Petechiae', scientific_text: 'Petechiae')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Point of Origin', scientific_text: 'Point of Origin')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Progression', scientific_text: 'Progression')
d_answergroup_skin.children.create(question_id: d_q27.id, option_text: 'Rash', scientific_text: 'Rash')
