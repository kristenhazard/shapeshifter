...
#symptoms
d_answergroup_gi = Hanuman::AnswerChoice.create(question_id: d_q32.id, option_text: 'GI', scientific_text: 'GI')
d_answergroup_gi.children.create(question_id: d_q32.id, option_text: 'Abdominal Pain', scientific_text: 'Abdominal Pain')
d_answergroup_gi.children.create(question_id: d_q32.id, option_text: 'Diarrhea', scientific_text: 'Diarrhea')
d_answergroup_gi.children.create(question_id: d_q32.id, option_text: 'Nausea', scientific_text: 'Nausea')
d_answergroup_gi.children.create(question_id: d_q32.id, option_text: 'Vomiting', scientific_text: 'Vomiting')
d_answergroup_neurologic = Hanuman::AnswerChoice.create(question_id: d_q32.id, option_text: 'Neurologic', scientific_text: 'Neurologic')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Ascending', scientific_text: 'Ascending')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Blurred Vision', scientific_text: 'Blurred Vision')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Decending', scientific_text: 'Decending')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Delirium', scientific_text: 'Delirium')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Dysphagia', scientific_text: 'Dysphagia')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Headache', scientific_text: 'Headache')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Pain', scientific_text: 'Pain')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Paralysis', scientific_text: 'Paralysis')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Photophobia', scientific_text: 'Photophobia')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Seizures', scientific_text: 'Seizures')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Slurred Speech', scientific_text: 'Slurred Speech')
d_answergroup_neurologic.children.create(question_id: d_q32.id, option_text: 'Weakness', scientific_text: 'Weakness')
d_answergroup_non_specific = Hanuman::AnswerChoice.create(question_id: d_q32.id, option_text: 'Non Specific', scientific_text: 'Non Specific')
d_answergroup_non_specific.children.create(question_id: d_q32.id, option_text: 'Diaphoresis', scientific_text: 'Diaphoresis')
d_answergroup_non_specific.children.create(question_id: d_q32.id, option_text: 'Fever', scientific_text: 'Fever')
d_answergroup_non_specific.children.create(question_id: d_q32.id, option_text: 'Malaise', scientific_text: 'Malaise')
d_answergroup_non_specific.children.create(question_id: d_q32.id, option_text: 'Nodes', scientific_text: 'Nodes')
d_answergroup_non_specific.children.create(question_id: d_q32.id, option_text: 'Rigors', scientific_text: 'Rigors')
d_answergroup_respiratory = Hanuman::AnswerChoice.create(question_id: d_q32.id, option_text: 'Respiratory', scientific_text: 'Respiratory')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Chest Pain', scientific_text: 'Chest Pain')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Cough', scientific_text: 'Cough')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Cyanosis', scientific_text: 'Cyanosis')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Dyspnea', scientific_text: 'Dyspnea')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Haemoptysis', scientific_text: 'Coughing Up Blood')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'Productive', scientific_text: 'Productive')
d_answergroup_respiratory.children.create(question_id: d_q32.id, option_text: 'X-Ray', scientific_text: 'X-Ray')
d_answergroup_skin = Hanuman::AnswerChoice.create(question_id: d_q32.id, option_text: 'Skin', scientific_text: 'Skin')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Bleedig Gums', scientific_text: 'Bleedig Gums')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Blisters', scientific_text: 'Blisters')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Bruising', scientific_text: 'Bruising')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Eschar', scientific_text: 'Eschar')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Masculopapular', scientific_text: 'Masculopapular')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Peeling', scientific_text: 'Peeling')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Petechiae', scientific_text: 'Petechiae')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Point of Origin', scientific_text: 'Point of Origin')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Progression', scientific_text: 'Progression')
d_answergroup_skin.children.create(question_id: d_q32.id, option_text: 'Rash', scientific_text: 'Rash')
